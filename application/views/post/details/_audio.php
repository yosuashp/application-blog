                ...
                <div class="row">
                    <div class="columns" id="amplitude-left">
                        <div class="amplitude-inner-left">
                            ...
                            <img src="<?= $img_base_url . $post->image_slider; ?>" alt="<?php echo $post->title; ?>"/>
                        </div>
    ...
    Amplitude.init({
        "songs": [
            ...
            if ($audio->storage == "aws_s3") {
                $audio_base_url = $this->aws_base_url;
            } ?>
            {
                "name": '<?php echo html_escape($audio->audio_name); ?>',
                "artist": '',
                "url": '<?= $audio_base_url . $audio->audio_path;  ?>',
                "cover_art_url": '<?= $img_base_url . $post->image_default;  ?>',
            },
            <?php endforeach; ?>
        ]
    });
