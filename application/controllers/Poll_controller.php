...
class Poll_controller extends Admin_Core_Controller
{
    ...
    {
        //validate inputs
        $this->form_validation->set_rules('question', trans("question"), 'required');
        $this->form_validation->set_rules('option1', trans("option_1"), 'required');
        $this->form_validation->set_rules('option2', trans("option_2"), 'required');
