                            ...
                            <div id="quiz_question_image_container_<?php echo $question->id; ?>">
                                <div class="quiz-question-image-container">
                                    <?php if (!empty($question->image_path)):
                                        ...
                                        <input type="hidden" name="question_image_storage_<?php echo $question->id; ?>" value="<?php echo $question->image_storage; ?>">
                                        <img src="<?= $img_base_url . $question->image_path; ?>" alt="">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <input type="hidden" name="question_image_storage_<?php echo $question->id; ?>" value="">
