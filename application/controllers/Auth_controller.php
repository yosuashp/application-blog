...
class Auth_controller extends Home_Core_Controller
{
    ...
    public function login_post()
    {
        ...
        $this->form_validation->set_rules('password', trans("form_password"), 'required|max_length[200]');
    ...
    public function register_post()
    {
        ...
        $this->reset_flash_data();
        //validate inputs
        $this->form_validation->set_rules('username', trans("form_username"), 'required|min_length[4]|max_length[100]');
        $this->form_validation->set_rules('email', trans("form_email"), 'required|max_length[200]');
        $this->form_validation->set_rules('password', trans("form_password"), 'required|min_length[4]|max_length[200]');
        $this->form_validation->set_rules('confirm_password', trans("form_confirm_password"), 'required|matches[password]');
    ...
    public function reset_password_post()
    {
        ...
        $this->form_validation->set_rules('password', trans("new_password"), 'required|min_length[4]|max_length[200]');
