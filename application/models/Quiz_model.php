...
class Quiz_model extends CI_Model
{
    ...
    */
    ...
    public function add_quiz_questions($post_id)
    {
        ...
        $question_image_storages = $this->input->post('question_image_storage', true);
        ...
        if (!empty($question_titles)) {
            for ($i = 0; $i < count($question_titles); $i++) {
                $data = array(
                    ...
                    'image_storage' => !empty($question_image_storages[$i]) ? $question_image_storages[$i] : '',
        ...
        if (!empty($questions)) {
            foreach ($questions as $question) {
                $data = array(
                    ...
                    'image_storage' => $this->input->post('question_image_storage_' . $question->id, true),
    ...
    public function add_quiz_answers($post_id, $question_id, $question_element_id)
    {
        ...
        if (!empty($post)) {
            if (!empty($question_id) && !empty($question_element_id)) {
                ...
                $answer_image_storages = $this->input->post('answer_image_question_storage_' . $question_element_id, true);
                ...
                if (!empty($answer_texts)) {
                    for ($i = 0; $i < count($answer_texts); $i++) {
                        ...
                        $data = array(
                            ...
                            'image_storage' => !empty($answer_image_storages[$i]) ? $answer_image_storages[$i] : '',
            ...
            if (!empty($answers)) {
                foreach ($answers as $answer) {
                    ...
                    $data = array(
                        ...
                        'image_storage' => $this->input->post('answer_image_storage_' . $answer->id, true),
    ...
    */
    ...
    public function add_quiz_results($post_id)
    {
        ...
        $result_image_storages = $this->input->post('result_image_storage', true);
        ...
        if (!empty($results)) {
            foreach ($results as $result) {
                $data = array(
                    ...
                    'image_storage' => $this->input->post('result_image_storage_' . $result->id, true),
