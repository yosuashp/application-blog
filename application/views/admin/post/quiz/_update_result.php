                            ...
                            <div id="quiz_result_image_container_<?php echo $result->id; ?>">
                                <div class="quiz-question-image-container">
                                    <?php if (!empty($result->image_path)):
                                        ...
                                        <input type="hidden" name="result_image_storage_<?php echo $result->id; ?>" value="<?php echo $result->image_storage; ?>">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <input type="hidden" name="result_image_storage_<?php echo $result->id; ?>" value="">
