                            ...
                            <table class="table table-bordered table-striped dataTable" id="cs_datatable" role="grid"
                                ...
                                <?php foreach ($languages as $item): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo admin_url(); ?>translations/<?php echo $item->id; ?>?show=50" class="btn btn-sm btn-info float-right m-b-5">
                                                <i class="fa fa-exchange"></i>&nbsp;&nbsp;<?php echo trans('edit_translations'); ?>
                                            </a>&nbsp;&nbsp;
                                            <?php echo form_open('language_controller/export_language_post', ['style' => 'display: inline-block']); ?>
