            ...
            <div id="quiz_answer_image_container_answer_<?php echo $answer->id; ?>" class="quiz-answer-image-item">
                <div class="quiz-answer-image-container">
                    <?php if (!empty($answer->image_path)):
                        ...
                        <input type="hidden" name="answer_image_storage_<?php echo $answer->id; ?>" value="<?php echo $answer->image_storage; ?>">
                        <img src="<?= $img_base_url . $answer->image_path; ?>" alt="">
                    ...
                    <?php else: ?>
                        ...
                        <input type="hidden" name="answer_image_storage_<?php echo $answer->id; ?>" value="">
